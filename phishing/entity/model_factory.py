...
MetricInfoArtifact = namedtuple("MetricInfoArtifact",
                                ["model_name", "model_object", "train_avg_precision", "test_avg_precision", "train_accuracy",
...
def evaluate_classification_model(model_list: list, X_train:np.ndarray, y_train:np.ndarray, X_test:np.ndarray, y_test:np.ndarray, base_accuracy:float=0.6) -> MetricInfoArtifact:
    ...
    try:
        ...
        for model in model_list:
            ...
            logging.info(f"Train average precision square : [{train_avg_precision}].")
            logging.info(f"Test average precision square : [{test_avg_precision}].")
